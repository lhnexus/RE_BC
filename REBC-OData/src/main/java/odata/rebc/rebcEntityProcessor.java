...
public class rebcEntityProcessor implements EntityProcessor {

	private static final Logger LOG = LoggerFactory.getLogger(rebcEntityProcessor.class);
	private OData odata;
	private ServiceMetadata serviceMetadata;
	private OModel storage;

	public rebcEntityProcessor(OModel storage) {
	...
	public void createEntity(ODataRequest request, ODataResponse response, UriInfo uriInfo, ContentType requestFormat,
		...
		EdmEntitySet edmEntitySet = REBCUtil.getEdmEntitySet(uriInfo);
		...
		EntitySerializerOptions options = EntitySerializerOptions.with().contextURL(contextUrl).build(); // expand
																											// and
																											// select
																											// currently
																											// not
